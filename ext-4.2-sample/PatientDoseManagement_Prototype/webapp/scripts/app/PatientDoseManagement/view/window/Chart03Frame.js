Ext.define('PDM.view.window.Chart03Frame', {
	extend: 'Ext.window.Window',
	alias: 'widget.windowchart03frame',
    id: 'window_chart03frame',
    ...
    createBody: function() {
        ...
        var body = Ext.widget('panel', {
            ...
            minWidth: 700,
            minHeight: 400,
            html: '<div id="' + global.constant.chart.id.chart03 +'"></div>',
        });
    ...
    drawChart: function() {
        ...
        $('#' + global.constant.chart.id.chart03).highcharts({
            chart: {
                type: 'column',
                animation: false
            },
    ...
    exportChartThumbnail: function() {
        var me = this;
        var svgHtml = $('#' + global.constant.chart.id.chart03 +' .highcharts-container')[0].innerHTML;
        ...
        global.current.thumbnailJPEG.quarter03 = image.data;
        global.current.thumbnailJPEG.half03 = image.data;
    },
