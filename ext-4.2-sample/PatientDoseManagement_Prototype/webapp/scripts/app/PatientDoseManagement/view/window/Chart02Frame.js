Ext.define('PDM.view.window.Chart02Frame', {
	extend: 'Ext.window.Window',
	alias: 'widget.windowchart02frame',
    id: 'window_chart02frame',
    ...
    createBody: function() {
        ...
        var body = Ext.widget('panel', {
            ...
            minWidth: 700,
            minHeight: 400,
            html: '<div id="' + global.constant.chart.id.chart02 +'"></div>',
        });
    ...
    drawChart: function() {
        ...
        $('#' + global.constant.chart.id.chart02).highcharts({
            chart: {
                type: 'column',
                animation: false
            },
    ...
    exportChartThumbnail: function() {
        var me = this;
        var svgHtml = $('#' + global.constant.chart.id.chart02 +' .highcharts-container')[0].innerHTML;
        ...
        global.current.thumbnailJPEG.quarter02 = image.data;
        global.current.thumbnailJPEG.half02 = image.data;
    },
