Ext.define('PDM.view.window.Chart01Frame', {
	extend: 'Ext.window.Window',
	alias: 'widget.windowchart01frame',
    id: 'window_chart01frame',
    ...
    createBody: function() {
        ...
        var body = Ext.widget('panel', {
            ...
            minWidth: 700,
            minHeight: 400,
            html: '<div id="' + global.constant.chart.id.chart01 +'"></div>',
        });
    ...
    drawChart: function() {
        ...
        $('#' + global.constant.chart.id.chart01).highcharts({
            chart: {
                type: 'column',
                animation: false
            },
    ...
    exportChartThumbnail: function() {
        var me = this;
        var svgHtml = $('#' + global.constant.chart.id.chart01 +' .highcharts-container')[0].innerHTML;
        ...
        global.current.thumbnailJPEG.quarter01 = image.data;
        global.current.thumbnailJPEG.half01 = image.data;
    },
